...
public class MesInscriptions extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ListView tvDisplay;
    ...
    public void showStringResponse(JSONArray response) {
        MyListAdapter adapter = new MyListAdapter(MesInscriptions.this, genererItems(response));
    ...
    public void doGetEvenementsAsString(String path) {
        ...
        String uri = "http://"+Data.adresse+"/api/v1/events/"+login;
    ...
    private List<Item> genererItems(JSONArray response){
        ...
        for (int i = 0 ; i < response.length() ; i++) {
            ...
            MyListAdapter adapter = new MyListAdapter(MesInscriptions.this, items);
            tvDisplay.setAdapter(adapter);
            tvDisplay.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent intent = new Intent(MesInscriptions.this, Details.class);
