...
CREATE TABLE reservation(idevent INT NOT NULL, iduser INT NOT NULL, FOREIGN KEY(idevent) REFERENCES evenement(id) CONSTRAINT ON DELETE CASCADE, FOREIGN KEY(iduser) REFERENCES utilisateur(id) CONSTRAINT ON DELETE CASCADE);
