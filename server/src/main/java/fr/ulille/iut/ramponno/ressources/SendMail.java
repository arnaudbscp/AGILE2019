...
public class SendMail {
    ...
    private final static String SENDGRID_API_KEY = "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"; // SENDGRID KEY WHO TO RECEIVE WHEN TO CREATE A NEW API KEY
