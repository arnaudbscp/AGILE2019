...
import fr.ulille.iut.ramponno.dao.EvenementEntity;
...
public class EvenementRessource {
    ...
    /* GET ALL EVENTS WITH THE PARTICIPANTS*/
    @GET
    ...
    /* UPDATE EVENETS FOR ADD NEW PARTICIPANTS AND SEND MAIL TO PARTICIPANTS */
    @PUT
    @Path("/{nom}/{login}")
    ...
    /* GET ONE PARTICIPANTS ALL EVENTS */
    @GET
    @Path("/{login}")
    @Produces(MediaType.APPLICATION_JSON)
